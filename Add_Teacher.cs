...
namespace University_Management_System
{
    public partial class Add_Teacher : Form
    {
        ...
        private int idGenerator()
        {
            ...
            int num = randomNum.Next(1000, 5000);
            return num;
        }
        private int idGenerator1()
        {
            Random randomNum = new Random();
            int num = randomNum.Next(5000, 9999);
            return num;
        }
        ...
        private void Create_btn_Click(object sender, EventArgs e)
        {
            ...
            person.Position = Position_cmbx.Text;
            ...
            if (!(path.Text == ""||FirstName_tb.Text =="" || LastName_tb.Text == "" || Email_tb.Text == "" || NID_tb.Text == "" || FatherName_tb.Text == "" || MotherName_tb.Text == "" || Position_cmbx.Text == "" || Mobile_tb.Text == "" || Position_cmbx.Text == "" || Department_cmbx.Text == "" ||
                House_tb.Text == "" || Road_tb.Text == "" || Area_tb.Text == "" || City_tb.Text == "" || Day_tb.Text == "" || Month_tb.Text == "" || Year_tb.Text == "" )&& (int.TryParse(Day_tb.Text, out _) || int.TryParse(Month_tb.Text, out _) || int.TryParse(Year_tb.Text, out _)))
            {
                ...
                string query;
                int result=0;
                query = "insert into TEACHER (Photo,Teacher_ID,First_Name,Last_Name,Email,NID,Father_Name,Mother_Name,Mobile,Position,Department_ID) values (@Photo,@Teacher_ID,@First_Name,@Last_Name,@Email,@NID,@Father_Name,@Mother_Name,@Mobile,@Position,@Department_ID)";/*@Password,@Photo,@Department_ID)";*/
                connection.Open();
